...
EstonConvoHandler = Object:new {
	themePark = nil
}
-- Goru screenplay states: 1: Quest started, 2: turned in zicx, 4: turned in bile, 8: completed
function EstonConvoHandler:setThemePark(themeParkNew)
	self.themePark = themeParkNew
end

function EstonConvoHandler:runScreenHandlers(conversationTemplate, conversingPlayer, conversingNPC, selectedOption, conversationScreen)
