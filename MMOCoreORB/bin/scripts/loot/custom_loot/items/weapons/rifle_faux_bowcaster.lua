rifle_faux_bowcaster = {
	minimumLevel = 0,
	maximumLevel = -1,
	customObjectName = "",
	directObjectTemplate = "object/weapon/ranged/rifle/rifle_faux_bowcaster.iff",
	craftingValues = {
		{"mindamage",47,96,0},
		{"maxdamage",100,188,0},
...
addLootItemTemplate("rifle_faux_bowcaster", rifle_faux_bowcaster)
