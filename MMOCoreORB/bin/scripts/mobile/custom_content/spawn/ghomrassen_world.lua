...
--[[		{
		...
		{
			lairTemplateName = "tatooine_womprat_slum_rat_neutral_none",
			spawnLimit = -1,
			minDifficulty = 60,
			maxDifficulty = 80,
			numberToSpawn = 0,
		...
		{
			lairTemplateName = "tatooine_diseased_bocatt_pack_neutral_none",
			spawnLimit = -1,
			minDifficulty = 60,
			maxDifficulty = 80,
			numberToSpawn = 0,
		...
		{
			lairTemplateName = "tatooine_bocatt_pack_neutral_none",
			spawnLimit = -1,
			minDifficulty = 60,
			maxDifficulty = 80,
			numberToSpawn = 0,
		...
		{
			lairTemplateName = "tatooine_imperial_camp",
			spawnLimit = -1,
			minDifficulty = 60,
			maxDifficulty = 80,
			numberToSpawn = 0,
