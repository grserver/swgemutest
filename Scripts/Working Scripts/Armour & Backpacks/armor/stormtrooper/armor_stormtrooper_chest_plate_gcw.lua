...
ObjectTemplates:addTemplate(object_tangible_wearables_armor_stormtrooper_armor_stormtrooper_chest_plate_gcw, "object/tangible/wearables/armor/stormtrooper/armor_stormtrooper_chest_plate_gcw.iff")
