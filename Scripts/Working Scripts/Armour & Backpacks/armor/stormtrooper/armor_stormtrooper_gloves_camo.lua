...
ObjectTemplates:addTemplate(object_tangible_wearables_armor_stormtrooper_armor_stormtrooper_gloves_camo, "object/tangible/wearables/armor/stormtrooper/armor_stormtrooper_gloves_camo.iff")
