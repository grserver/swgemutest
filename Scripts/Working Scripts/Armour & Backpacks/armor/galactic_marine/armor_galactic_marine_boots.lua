...
ObjectTemplates:addTemplate(object_tangible_wearables_armor_galactic_marine_armor_galactic_marine_boots, "object/tangible/wearables/armor/galactic_marine/armor_galactic_marine_boots.iff")
