...
ObjectTemplates:addTemplate(object_tangible_wearables_armor_galactic_marine_armor_galactic_marine_bracer_r, "object/tangible/wearables/armor/galactic_marine/armor_galactic_marine_bracer_r.iff")
