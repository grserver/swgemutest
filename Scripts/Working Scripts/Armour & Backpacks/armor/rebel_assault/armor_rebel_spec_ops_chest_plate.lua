...
ObjectTemplates:addTemplate(object_tangible_wearables_armor_rebel_assault_armor_rebel_spec_ops_chest_plate, "object/tangible/wearables/armor/rebel_assault/armor_rebel_spec_ops_chest_plate.iff")
