...
object_weapon_melee_knife_knife_survival_decorative = object_weapon_melee_knife_shared_knife_survival_decorative:new {
...
ObjectTemplates:addTemplate(object_weapon_melee_knife_knife_survival_decorative, "object/weapon/melee/knife/knife_survival_decorative.iff")
