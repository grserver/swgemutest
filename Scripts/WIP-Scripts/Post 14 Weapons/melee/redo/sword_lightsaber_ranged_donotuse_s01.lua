...
ObjectTemplates:addTemplate(object_weapon_melee_sword_crafted_saber_sword_lightsaber_ranged_donotuse_s01, "object/weapon/melee/sword/crafted_lightsaber/sword_lightsaber_ranged_donotuse_s01.iff")
