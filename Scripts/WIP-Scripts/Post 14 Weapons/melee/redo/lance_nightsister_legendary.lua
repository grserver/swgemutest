...
object_weapon_melee_polearm_lance_nightsister_legendary = object_weapon_melee_polearm_shared_lance_nightsister_legendary:new {
...
ObjectTemplates:addTemplate(object_weapon_melee_polearm_lance_nightsister_legendary, "object/weapon/melee/polearm/lance_nightsister_legendary.iff")
