...
object_weapon_melee_polearm_lance_kaminoan_generic = object_weapon_melee_polearm_shared_lance_kaminoan_generic:new {
...
ObjectTemplates:addTemplate(object_weapon_melee_polearm_lance_kaminoan_generic, "object/weapon/melee/polearm/lance_kaminoan_generic.iff")
