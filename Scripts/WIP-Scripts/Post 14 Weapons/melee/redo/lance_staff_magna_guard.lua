...
object_weapon_melee_polearm_lance_staff_magna_guard = object_weapon_melee_polearm_shared_lance_staff_magna_guard:new {
...
ObjectTemplates:addTemplate(object_weapon_melee_polearm_lance_staff_magna_guard, "object/weapon/melee/polearm/lance_staff_magna_guard.iff")
