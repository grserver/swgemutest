...
object_weapon_melee_polearm_polearm_vibro_axe_npe = object_weapon_melee_polearm_shared_polearm_vibro_axe_npe:new {
...
ObjectTemplates:addTemplate(object_weapon_melee_polearm_polearm_vibro_axe_npe, "object/weapon/melee/polearm/polearm_vibro_axe_npe.iff")
