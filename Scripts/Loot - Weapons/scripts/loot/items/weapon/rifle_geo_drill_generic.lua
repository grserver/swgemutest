rifle_geo_drill_generic = {
	minimumLevel = 0,
	maximumLevel = -1,
	customObjectName = "",
	directObjectTemplate = "object/weapon/ranged/rifle/rifle_geo_drill_generic.iff",
	craftingValues = {
		{"mindamage",47,96,0},
		{"maxdamage",100,188,0},
...
addLootItemTemplate("rifle_geo_drill_generic", rifle_geo_drill_generic)
