rifle_bowcaster_medium = {
	minimumLevel = 0,
	maximumLevel = -1,
	customObjectName = "",
	directObjectTemplate = "object/weapon/ranged/rifle/rifle_bowcaster_medium.iff",
	craftingValues = {
		{"mindamage",47,96,0},
		{"maxdamage",100,188,0},
...
addLootItemTemplate("rifle_bowcaster_medium", rifle_bowcaster_medium)
