som_rifle_dp23_generic = {
	minimumLevel = 0,
	maximumLevel = -1,
	customObjectName = "",
	directObjectTemplate = "object/weapon/ranged/rifle/som_rifle_dp23_generic.iff",
	craftingValues = {
		{"mindamage",47,96,0},
		{"maxdamage",100,188,0},
...
addLootItemTemplate("som_rifle_dp23_generic", som_rifle_dp23_generic)
