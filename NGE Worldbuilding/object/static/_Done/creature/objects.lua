...
--New
object_static_creature_shared_som_droid_mining_facility = SharedStaticObjectTemplate:new {
	clientTemplateFileName = "object/static/creature/shared_som_droid_mining_facility.iff"

}
ObjectTemplates:addClientTemplate(object_static_creature_shared_som_droid_mining_facility, "object/static/creature/shared_som_droid_mining_facility.iff")
