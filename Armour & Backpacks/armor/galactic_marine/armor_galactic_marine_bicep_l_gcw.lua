...
ObjectTemplates:addTemplate(object_tangible_wearables_armor_galactic_marine_armor_galactic_marine_bicep_l_gcw, "object/tangible/wearables/armor/galactic_marine/armor_galactic_marine_bicep_l_gcw.iff")
