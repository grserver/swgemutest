...
ObjectTemplates:addTemplate(object_tangible_wearables_armor_mandalorian_rebel_armor_mandalorian_rebel_boots, "object/tangible/wearables/armor/mandalorian_rebel/armor_mandalorian_rebel_boots.iff")
