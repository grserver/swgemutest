...
ObjectTemplates:addClientTemplate(object_tangible_wearables_armor_stormtrooper_shared_armor_stormtrooper_chest_plate_camo, "object/tangible/wearables/armor/stormtrooper/shared_armor_stormtrooper_chest_plate._camoiff")
